...
// ** Data Import
import { rows } from 'src/@fake-db/watterson/table/latest-coverage'
...
const TableLatestCoverage = () => {
  // ** States
  const [data] = useState<LatestCoverage[]>(rows)
  const [searchText, setSearchText] = useState<string>('')
  const [filteredData, setFilteredData] = useState<LatestCoverage[]>([])
...
export default TableLatestCoverage
